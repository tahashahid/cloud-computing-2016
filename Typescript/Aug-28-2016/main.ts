var todos : string[] = JSON.parse(localStorage.getItem("list")) || [];
genList();
document.getElementById("enterBtn")
.addEventListener("click", function(){
    
    var inputValue : string = (<HTMLInputElement>document.getElementById("textField")).value;
...
function editItem(index: number){
    ...
    var a = todos[index];    
    todos.splice(index, 1);
    (<HTMLInputElement>document.getElementById("textField")).value = a;
