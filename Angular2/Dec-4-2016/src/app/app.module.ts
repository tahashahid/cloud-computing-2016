...
import { Compoenent1Component } from './compoenent1/compoenent1.component';
import { Compoenent2Component } from './compoenent2/compoenent2.component';
...
@NgModule({
  declarations: [
    ...
    Compoenent1Component,
    Compoenent2Component,
  ],
  imports: [
    BrowserModule,
    FormsModule,
